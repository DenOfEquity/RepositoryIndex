...
### Image enhancement ###
* [auraSR](https://github.com/DenOfEquity/auraSR-webUI) *4x super resolution, adds new tab - or use branch `upscaler` to add to the webUI upscaler list for use in **HiResFix** and the **Extras** tab*
